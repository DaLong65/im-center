...
import com.works.service.handler.BaseHandler;
    ...
    public void onMessage(Message message, byte[] bytes) {
        ...
        try {
            ...
            if (clientBroadcastMessage.getTimestamp().equals(timestamp)
                    && localChannelSessionService.getChannelId(uid).equals(remoteChannelSessionService.getChannelId(uid))) {
                return;
            }

            super.closeChannel(localChannelSessionService.getOrDefault(uid, null));
